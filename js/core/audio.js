// === AUDIO SINTETICO — sin archivos externos ===
...
class AudioEngine {
    ...
    // Sonido al recoger puntos en un nodo — tono que sube con el acumulado
    ...
    // Al aplicar multiplicador — barrido + acorde
    playMultApply(mult) {
        this.ensure();
    ...
    // Re-roll — dados rebotando de nuevo
    playReroll() {
        this.ensure();
        for (let i = 0; i < 4; i++) {
            setTimeout(() => {
