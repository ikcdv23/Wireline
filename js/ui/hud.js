...
class HUD {
    ...
    // Actualizar el score en tiempo real durante la animacion de corriente
    setLiveScore(value) {
        this.els.score.textContent = value;
        this.updateScoreStyle(value);
    }

    // Estilo del score segun relacion con el target
